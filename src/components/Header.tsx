...
export default function Header() {
  ...
  return (
    <>
      {/* 📥 AYESHA'S FIX: COMPILER-SAFE STANDARD FIXED OVERLAY MODAL */}
      {showGuide ? (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-slate-900 text-white p-6 rounded-2xl max-w-sm w-full border border-slate-700 shadow-2xl relative">
            ...
            <button 
              ...
              className="w-full bg-emerald-500 hover:bg-emerald-600 text-white py-3 rounded-xl font-semibold tracking-wider transition-all duration-150 active:scale-[0.98] shadow-md text-sm"
            >
              Got It, Close Guide
            </button>
          </div>
